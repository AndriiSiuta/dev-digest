 ...
 *
 *   GET /pulls/:id/smart-diff → files classified core/wiring/boilerplate,
 *   overlaid with the latest review's findings. No model call: computed
 *   fresh on every request from `pr_files` + `reviews`/`findings`.
 */
